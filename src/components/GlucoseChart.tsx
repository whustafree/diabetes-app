...
export default function GlucoseChart({ entries }: GlucoseChartProps) {
 ...
 <TrendingUp className="w-12 h-12 text-gray-300 text-gray-400 mx-auto mb-3"/>
 <p className="text-gray-400 font-medium">No hay datos para mostrar el gráfico</p>
 <p className="text-gray-300 text-gray-400 text-sm mt-1">Registra mediciones para ver tendencias</p>
 </div>
 );
 }
 ...
 <CartesianGrid strokeDasharray="3 3"stroke="currentColor"className="text-gray-100 text-gray-700"/>
 <XAxis
 dataKey="time"
 ...
 <span className="text-xs text-gray-400 text-gray-500">Rango bajo (&lt;70)</span>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded-full bg-yellow-500"/>
 <span className="text-xs text-gray-400 text-gray-500">Rango alto (&gt;140)</span>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-3 h-3 rounded-full bg-green-500"/>
 <span className="text-xs text-gray-400 text-gray-500">Rango normal</span>
 </div>
 </div>
 </div>
 );
