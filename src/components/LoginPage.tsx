...
export default function LoginPage() {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-slate-900 flex flex-col transition-colors duration-300">
 {/* ─── TOP BAR ─── */}
 ...
 {/* ─── AUTH CARD ─── */}
 <div className="bg-gray-800 rounded-3xl p-6 sm:p-8 shadow-xl shadow-gray-200/50 shadow-black/20 border border-gray-700">
 {/* Error message */}
 {error && (
 <div className="p-3.5 rounded-2xl bg-red-900/30 border border-red-700 border-red-800 flex items-start gap-2.5 mb-5">
 ...
 {/* Success message */}
 {success && (
 <div className="p-3.5 rounded-2xl bg-green-900/30 border border-green-700 border-green-800 flex items-start gap-2.5 mb-5">
 ...
 className="w-full flex items-center justify-center gap-2 text-sm text-gray-400 hover:text-gray-300 hover:text-gray-200 transition-colors py-2"
 >
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-400 hover:text-gray-300 transition-colors"
 >
 ...
 className="w-4 h-4 rounded-lg border-gray-300 border-gray-600 text-blue-400 focus:ring-blue-400 cursor-pointer accent-blue-600"
 />
 <span className="text-sm text-gray-400 group-hover:text-gray-700 group-hover:text-gray-200 transition-colors">
 Recordarme
 </span>
 </label>
 <button
 ...
 <span className="px-3 text-xs text-gray-400 text-gray-400 bg-gray-800">
 O continúa con
 </span>
 </div>
 </div>
 ...
 {/* ─── FOOTER ─── */}
 <p className="text-center text-xs text-gray-300 text-gray-400 mt-6">
...
function DemoModeCard() {
 ...
 return (
 <div className="bg-gray-800 rounded-2xl p-5 border border-dashed border-gray-700 border-gray-600">
 ...
 <p className="text-[10px] text-gray-400 text-gray-400 mt-2 text-center">
