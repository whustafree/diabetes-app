...
export default function GlucoseLog({ entries, onEntryDeleted }: GlucoseLogProps) {
 ...
 <div key={dateKey}>
 <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-3 px-1">
 {dateKey}
 </h4>
 ...
 <div
 key={entry.id}
 className="group bg-gray-800 rounded-xl p-4 border border-gray-700 hover:border-gray-200 hover:border-gray-600 hover:shadow-sm transition-all duration-200 fade-in"
 >
 ...
 <div className="flex items-center gap-3 mt-1 text-xs text-gray-400 text-gray-500">
 ...
 <p className="text-xs text-gray-400 text-gray-400 mt-1 italic">
 {entry.notes}
 </p>
 )}
 </div>
