      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          <div className="space-y-5">
            ...
            {/* Activity Level */}
            <div>                <label className="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1.5 flex items-center gap-1.5">
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 dark:text-white focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all appearance-none"
              >
            ...
            <div>                <label className="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1.5 flex items-center gap-1.5">
                  ...
                  Peso deseado (kg) <span className="text-gray-400 dark:text-gray-500 font-normal">- opcional</span>
              </label>
              <input
                type="number"
            ...
            <div>                <label className="block text-sm font-semibold text-gray-600 dark:text-gray-300 mb-1.5 flex items-center gap-1.5">
                  <Activity className="w-4 h-4" />
                  Medicamentos <span className="text-gray-400 dark:text-gray-500 font-normal">- opcional</span>
              </label>
              <input
                type="text"
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-blue-200 dark:shadow-blue-800/50">
            ...
            <div>
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 mt-1">
            ...
            {firebaseReady && user && (
              <div className="relative" ref={profileLogoutRef}>
                ...
                {showProfileLogoutConfirm && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 z-50 p-4 animate-[fadeIn_0.15s_ease-out]">
                    <p className="text-sm font-semibold text-gray-800 dark:text-white mb-1">¿Cerrar sesión?</p>
                    <p className="text-xs text-gray-400 dark:text-gray-500 mb-3">Tus datos locales se conservarán.</p>
                    <div className="flex gap-2">
                      <button
                        onClick={() => setShowProfileLogoutConfirm(false)}
                        className="flex-1 py-2 rounded-xl text-xs font-semibold bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all"
                      >
                        Cancelar
                      </button>
                      <button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div key={card.label} className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all">
            <div className="flex items-start justify-between mb-2">
              <span className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">{card.label}</span>
      ...
      {/* Targets */}        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500 dark:text-gray-400">Actual: <strong>{profile.weight} kg</strong></span>
              <span className="text-gray-500 dark:text-gray-400">Meta: <strong>{profile.targetWeight} kg</strong></span>
            </div>
