...
export default function SettingsPage() {
 ...
 {/* Tabs */}
 <div className="flex gap-2 bg-gray-100/80 bg-gray-700/80 rounded-2xl p-1.5 max-w-sm">
 {[
 ...
 userRole === 'admin'
 ? 'bg-indigo-100 bg-indigo-900/40 text-indigo-400'
 ...
 className="px-4 py-2 rounded-xl text-xs font-semibold text-indigo-400 bg-indigo-900/20 hover:bg-indigo-100 hover:bg-indigo-900/40 border border-indigo-700 border-indigo-800 transition-all"
 >
 ...
 {exportStats.map(s => (
 <span key={s.key} className="text-[10px] px-2 py-1 rounded-lg bg-gray-700 bg-gray-600 text-gray-400 font-medium">
 ...
 disabled={exporting}
 className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-blue-400 bg-blue-900/20 hover:bg-blue-100 hover:bg-blue-900/40 border border-blue-700 border-blue-800 transition-all disabled:opacity-50"
 >
 ...
 className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-green-400 bg-green-900/20 hover:bg-green-100 hover:bg-green-900/40 border border-green-700 border-green-800 transition-all disabled:opacity-50"
 >
 ...
 <div key={key} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-700/30 transition">
 <div className="flex items-center gap-3">
 <span className="text-lg">{icon}</span>
 <div>
 <p className="text-sm font-semibold text-gray-300 text-gray-200">{label}</p>
 ...
 {/* Cerrar Sesión */}
 <div className="bg-gray-800 rounded-2xl p-6 shadow-sm border border-yellow-100 border-yellow-900/30">
 ...
 className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-yellow-400 bg-yellow-900/20 hover:bg-yellow-100 hover:bg-yellow-900/40 border border-yellow-700 border-yellow-800 transition-all"
 >
 ...
 <p className="text-sm text-gray-400 text-gray-400 mb-6">
 Ingresa tu contraseña actual y una nueva contraseña.
 Debe tener al menos 6 caracteres.
 </p>

 {passwordSuccess && (
 <div className="p-4 rounded-xl bg-green-900/30 border border-green-700 border-green-800 flex items-start gap-3 mb-4 animate-[fadeIn_0.3s_ease-out]">
 <CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0"/>
 <div>
 <p className="text-sm font-semibold text-green-300">Contraseña actualizada</p>
 <p className="text-xs text-green-400 mt-0.5">Tu contraseña se ha cambiado exitosamente.</p>
 </div>
 </div>
 )}

 {passwordError && (
 <div className="p-4 rounded-xl bg-red-900/30 border border-red-700 border-red-800 flex items-start gap-3 mb-4 animate-[fadeIn_0.3s_ease-out]">
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-400 hover:text-gray-300 transition"
 >
 ...
 <p className="text-[11px] text-gray-400 text-gray-400 mt-1">
 ...
 className="text-[11px] text-red-400 font-semibold hover:text-red-600 transition"
 >
 Limpiar historial
 </button>
 )}
 ...
 <div className="p-3 rounded-xl bg-blue-900/20 border border-blue-100 border-blue-800 text-center">
 <p className="text-lg font-bold text-blue-400">{activityLog.length}</p>
 <p className="text-[10px] text-blue-400 text-blue-300 font-medium">Total</p>
 </div>
 <div className="p-3 rounded-xl bg-green-900/20 border border-green-100 border-green-800 text-center">
 <p className="text-lg font-bold text-green-400">
 {filteredLog.filter(e => e.type !== 'logout' && e.type !== 'account_delete').length}
 </p>
 <p className="text-[10px] text-green-400 text-green-300 font-medium">Activas</p>
 </div>
 <div className="p-3 rounded-xl bg-purple-900/20 border border-purple-100 border-purple-800 text-center">
 <p className="text-lg font-bold text-purple-400">{activityTypes.length}</p>
 <p className="text-[10px] text-purple-400 text-purple-300 font-medium">Tipos</p>
 </div>
 </div>
 )}
 ...
 activityFilter === 'all'
 ? 'bg-blue-100 bg-blue-900/40 text-blue-400'
 : 'bg-gray-700 text-gray-400 hover:bg-gray-200 hover:bg-gray-600'
 }`}
 >
 Todos
 </button>
 ...
 <div
 key={entry.id}
 className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-700/50 transition group"
 >
 ...
 <span className="text-[10px] font-medium text-gray-300 text-gray-400 group-hover:text-gray-500 group-hover:text-gray-400 transition">
 {formatTimestamp(entry.timestamp)}
 </span>
 <Clock className="w-3 h-3 text-gray-300 text-gray-600"/>
 </div>
 </div>
 );
 })}
 ...
 <p className="text-sm text-red-300 font-medium">Se eliminará todo tu contenido en la nube:</p>
 ...
 icon={Shield}
 iconBgColor="bg-indigo-100 bg-indigo-900/40"
 ...
 customIcon={<Shield className="w-5 h-5 text-indigo-400"/>}
 >
 <div className="bg-indigo-900/20 rounded-xl p-4 mb-4 border border-indigo-700 border-indigo-800">
